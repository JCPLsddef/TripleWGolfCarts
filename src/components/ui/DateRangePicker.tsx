            ...
            <div className="p-4 md:p-6">
              <DayPicker
                ...
                classNames={{
                  ...
                  day: "w-full h-11 md:h-12 flex items-center justify-center text-sm font-medium transition-all duration-150 cursor-pointer",
                  day_selected: "!bg-primary !text-white font-bold hover:!bg-primary-hover rounded-lg",
                  day_today: "font-bold text-primary ring-2 ring-primary/30 ring-inset rounded-lg",
                  day_outside: "text-text-muted/30 cursor-default hover:bg-transparent rounded-lg",
                  day_disabled: "text-text-muted/30 cursor-not-allowed hover:bg-transparent line-through rounded-lg",
                  day_range_start: "!bg-primary !text-white rounded-lg",
                  day_range_end: "!bg-primary !text-white rounded-lg",
                  day_range_middle: "!bg-primary/15 !text-text rounded-none hover:!bg-primary/25",
